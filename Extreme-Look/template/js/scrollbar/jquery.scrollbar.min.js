    ...
    n.prototype = {
        destroy: function () {
            if (this.wrapper) {
                ...
                this.container.insertBefore(this.wrapper).css({ height: "", margin: "", "max-height": "" }).removeClass("scroll-content scroll-scrollx_visible scroll-scrolly_visible").off(this.namespace).scrollLeft(e).scrollTop(o),
        ...
        init: function (e) {
            ...
            if (d) i.css({ height: "auto", "margin-bottom": -1 * t.scroll.height + "px", "margin-right": -1 * t.scroll.width + "px", "max-height": "" });
                ...
                if (
                    ((this.wrapper = d = l("<div>")
                        ...
                        .addClass("top-fixed-id")
                        .addClass(r.attr("class"))
                        //.css("position", "absolute" == r.css("position") ? "absolute" : "relative")
                        .insertBefore(r)
                        .append(r)),
                    r.is("textarea") && ((this.containerWrapper = i = l("<div>").insertBefore(r).append(r)), d.addClass("scroll-textarea")),
                    ...
                    t.scroll.find(".scroll-arrow, .scroll-element_track").on("mousedown" + n, function (s) {
                        ...
                        return (
                            l(this).hasClass("scroll-arrow")
                                ...
                                : ((d = n.eventOffset > n.scrollbarOffset + n.scrollbarSize ? 1 : n.eventOffset < n.scrollbarOffset ? -1 : 0),
            ...
            l.isFunction(c.onUpdate) && c.onUpdate.apply(this, [r]),
                l.each(a, function (l, e) {
                    ...
                    c.autoScrollSize && ((e.scrollbarSize = parseInt((d * a) / n, 10)), e.scroll.bar.css(t, e.scrollbarSize + "px")),
        ...
        _getScroll: function (e) {
            ...
            return (
                ...
                e || (e = o.simple),
                    ...
                    l.extend(e, { bar: e.find(".scroll-bar"), size: e.find(".scroll-element_size"), track: e.find(".scroll-element_track") }),
                    e
            );
        },
        ...
        _updateScroll: function (e, o) {
            ...
            (l.extend(this.scrollx, { offset: parseInt(s.css("left"), 10) || 0, size: s.prop("scrollWidth"), visible: a.width() }),
                l.extend(this.scrolly, { offset: parseInt(s.css("top"), 10) || 0, size: this.container.prop("scrollHeight"), visible: a.height() }),
