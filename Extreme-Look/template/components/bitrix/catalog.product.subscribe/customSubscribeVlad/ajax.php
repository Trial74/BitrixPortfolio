...
if($request->isAjaxRequest() && $request->get("action") == "reArSubUser") {
    $APPLICATION->IncludeComponent("bitrix:catalog.product.subscribe.list", "customSubListVlad",
        array());
    echo Bitrix\Main\Web\Json::encode(array("rearsubuser" => "ok", "global" => $GLOBALS['LIST_SUBSCRIPTIONS']));
}