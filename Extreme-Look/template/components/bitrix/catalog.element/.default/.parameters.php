...
$arTemplateParameters['QUICK_POPUP_VLAD'] = array( //Мой код. Параметр для определения как пользователь открыл товар в быстром просмотре или на странице для разделения подгрузки скриптов, чтобы на одной странице не инклюдились скрипты с одинаковыми идентификаторами.
    'PARENT' => 'VISUAL',
    'NAME' => 'Мой параметр для разделения скриптов при открытии в отдельном окне',
    'TYPE' => 'TEXT',
    'MULTIPLE' => 'N',
    'REFRESH' => 'N',
    'DEFAULT' => false
