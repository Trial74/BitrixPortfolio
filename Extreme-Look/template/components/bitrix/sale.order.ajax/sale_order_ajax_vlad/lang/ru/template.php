...
$MESS["SOA_NOT_CALCULATED"] = "не включена";
...
$MESS["SOA_ORDER_SUC1"] = "В ближайшее время наш менеджер свяжется с вами.";
...
$MESS["USE_COUPON_DEFAULT"] = "Введите промокод или номер скидочной карты";
...
";
$MESS["DELIVERY_CALC_ERROR_TITLE_DEFAULT"] = "Стоимость доставки будет рассчитана менеджером.";
...
$MESS["MY_ERROR_SITY_FIRST"] = "В выбранном городе ";
$MESS["MY_ERROR_SITY_SECOND"] = " заказ не доступен. Вы можете заказать товар через официального представителя";
$MESS["SOA_BONUS_TOOLTIP"] = "Бонусами можно воспользоваться через 14 дней, не считая дня покупки, оплатив ими до 50% стоимости товара. В период акций, проводимых компанией, на бонусы могут действовать ограничения.";
$MESS["SOA_BONUS"] = "Баллы и бонусы";
$MESS["SOA_BONUS_ENROLL"] = "Списать: ";
$MESS["SOA_BONUS_WRITE_OFF"] = "Начислить: ";
