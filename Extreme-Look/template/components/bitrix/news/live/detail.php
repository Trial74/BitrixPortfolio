...
$APPLICATION->SetAdditionalCSS(SITE_TEMPLATE_PATH."/css/bootstrap.min-5_2.css");
...
$APPLICATION->AddHeadScript("https://yastatic.net/es5-shims/0.0.2/es5-shims.min.js");
$APPLICATION->AddHeadScript("https://yastatic.net/share2/share.js");

$this->setFrameMode(true);

//ELEMENT//?>
<?$elementId = $APPLICATION->IncludeComponent("bitrix:news.detail", "live",
    Array(
