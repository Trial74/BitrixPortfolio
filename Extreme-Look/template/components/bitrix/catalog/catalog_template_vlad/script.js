(function() {
	...
	window.JCCatalogComponent.prototype = {
		init: function() {
			...
			this.sectionSortContainerMobile = document.body.querySelector('[data-role="catalogSectionSortMobile"]'); //Мой код добавляем сортировку для мобилки
			this.sectionSortPopup = this.sectionSortContainer && this.sectionSortContainer.querySelector('[data-role="dropdownContent"]');
			this.sectionSortPopupMobile = this.sectionSortContainerMobile && this.sectionSortContainerMobile.querySelector('[data-role="dropdownContentMobile"]');//Мой код выпадающее меню на мобилке
			if(this.sectionSortContainer && this.sectionSortPopup && this.sectionSortContainerMobile && this.sectionSortPopupMobile) {
				BX.bind(this.sectionSortContainerMobile, 'click', BX.proxy(this.showSectionSortDropDownPopupMobile, this))
		...
		showSectionSortDropDownPopupMobile: function() {
			if(BX.isNodeHidden(this.sectionSortPopupMobile)) {
				BX.style(this.sectionSortPopupMobile, 'display', '');
				BX.addClass(this.sectionSortContainerMobile, 'active');
				console.log(this.sectionSortPopupMobile);
			} else {
				BX.style(this.sectionSortPopupMobile, 'display', 'none');
				BX.removeClass(this.sectionSortContainerMobile, 'active');
			}
		},
