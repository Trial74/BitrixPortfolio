...
JCSmartFilter.prototype.init = function() {
	...
	if(!!this.filter) {
		...
		this.btnShowFilterMobile = document.body.querySelector('[data-entity="showFilterMobile"]');//Мой код своя кнопка для мобилок
...
JCSmartFilter.prototype.adjustFilter = function() {
	if(!!this.filterToogle) {
		if(!BX.isNodeHidden(this.filterToogle.parentNode)) {
			...
			if(!!this.btnShowFilter && !!this.btnShowFilterMobile) {
				BX.unbind(this.btnShowFilterMobile, 'click', BX.proxy(this.showFilter, this)); //Мой код клик в мобилке вызываем фильтр
			...
			if(!!this.btnShowFilter && !!this.btnShowFilterMobile) {
				BX.bind(this.btnShowFilterMobile, 'click', BX.proxy(this.showFilter, this)); //Мой код клик в мобилке вызываем фильтр
