...
/*$this->addExternalCss(SITE_TEMPLATE_PATH."/js/owlCarousel/owl.carousel.min.css"); Мой код в связи с реализацией слайдеров для карточек товаров вывод таблиц стилей и библиотеки слайдера перенесён в шапку чтобы не конфликтовало
...
<div class="slider-wrapper">
	<div class="slider" id="<?=$containerName?>">		
		<?foreach($arResult["ITEMS"] as $arItem) {
			...
			<div class="slider-item" <?=$itemPropImageVideo["IMG"] ? "data-image-src='" . $itemPropImageVideo['DESC_IMG_VIDEO'] . "' data-mobile-image-src='" . $itemPropImageVideo['MOBILE_IMG_VIDEO'] . "'" : "data-video-src='" . $itemPropImageVideo['DESC_IMG_VIDEO'] . "' data-video-mobile-src='" . $itemPropImageVideo['MOBILE_IMG_VIDEO'] . "'"?> <?=$itemPropImageVideo["IMG"] ? "data-image-width='" . $itemPropImageVideo['DESC_WIDTH'] . "' data-image-height='" . $itemPropImageVideo['DESC_HEIGHT'] . "' data-mobile-image-width='" . $itemPropImageVideo['MOBILE_WIDTH'] . "' data-mobile-image-height='" . $itemPropImageVideo['MOBILE_HEIGHT'] . "'" : "data-video-width='" . $itemPropImageVideo['DESC_WIDTH'] . "' data-video-height='" . $itemPropImageVideo['DESC_HEIGHT'] . "' data-video-mobile-width='" . $itemPropImageVideo['MOBILE_WIDTH'] . "' data-video-mobile-height='" . $itemPropImageVideo['MOBILE_HEIGHT'] . "'"?>>
				...
				<?if(!empty($itemPropImageVideo['URL_SITE'])) {?>
					<a class="slider-item__link" href="<?=$itemPropImageVideo['URL_SITE']?>"></a>
				<?}?>
			</div>
            <?$itemPropImageVideo = array();?>
		<?}?>
