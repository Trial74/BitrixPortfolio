...
?>
    ...
    <div class="container">
        <h1 style="text-align: center;">Подписаться на новостную рассылку <br />EXTREME LOOK</h1>
        <h2>Возможность получить информацию о новинках, закрытых распродажах, акциях и о многом другом.</h2>
        <form role="form" method="post" action="<?=$arResult["FORM_ACTION"]?>"  onsubmit="BX('bx_subscribe_btn_<?=$buttonId?>').disabled=true;">
            <?=bitrix_sessid_post()?>
            <input type="hidden" name="sender_subscription" value="add">

            <div class="bx-input-group" style="padding-bottom: 15px;">
    ...
    <!--		<?/*if(count($arResult["RUBRICS"])>0):*/?>
            ...
            <div class="bx_subscribe_submit_container">
                <button class="btn btn-buy" id="bx_subscribe_btn_<?=$buttonId?>"><span><?=GetMessage("subscr_form_button")?></span></button>
            </div>
        </form>
    </div>
<?
