...
$MESS['SOA_INVALID_EMAIL_PARTNER'] = "Почтовый адрес который вы ввели является партнёрским, для продолжения заказа Вам необходимо <a href='#' data-login-screen='#login-screen' class='link login-screen-open'>авторизоваться</a> в приложении. Если у Вас в Вашем профиле были добавлены товары в корзину то после авторизации к ним добавятся товары которые Вы добавили в корзину будучи неавторизованным, проверте состояния товаров в корзине после авторизации.";
...
$MESS['SOA_ORDER_SUC1'] = "Следить за дальнейшим статусом Вашего заказа можно через <a href=\"#LINK#\">личный кабинет</a>,этот сервис позволят отслеживать дальнейшее движение и местонахождение Вашего груза. Пожалуйста,сохраняйте данные о логине и пароле для повторного входа на сайт";
$MESS['SOA_PAY'] = "Оплата заказа";
$MESS['SOA_PAY_LINK'] = "Если окно с платежной информацией не открылось автоматически, нажмите на ссылку <a href=\"https://extreme-look.ru#LINK#\" class=\"open-other-link\" >Оплатить заказ</a>.";
...
$MESS['SOA_OTHER_CONSENT'] = 'Нажимая кнопку «Оформить заказ», я даю свое согласие на обработку моих персональных данных, в соответствии с Федеральным законом от 27.07.2006 года №152-ФЗ «О персональных данных», на условиях и для целей, определенных в Согласии на обработку персональных данных';
