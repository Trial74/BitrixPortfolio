<?if($active && $active == 'basket'){
	$APPLICATION->IncludeComponent("dresscode:sale.basket.basket", 'basket',
        array(
            "PATH_TO_ORDER" => "",
            "HIDE_COUPON" => "N",
        ...
        false);
}elseif($active && $active == 'delay'){?>
    <?$APPLICATION->IncludeComponent("dresscode:sale.basket.basket", 'delay', array(
        "CATALOG_MESS_BTN_BUY" => "Купить",
        "CATALOG_MESS_BTN_ADD_TO_BASKET" => "В корзину",
        "CATALOG_MESS_BTN_SUBSCRIBE" => "Сообщить о поступлении",
        "CATALOG_MESS_BTN_DETAIL" => "Подробнее",
...
<?}elseif($active && $active == 'subscribe'){?>
	<div class="block empty-cart" style="text-align: center;">
		<?$APPLICATION->IncludeComponent("bitrix:catalog.product.subscribe.list", '', [], false);?>
	</div>
<?}else{?>
	<div class="block empty-cart verticalize" style="text-align: center;">
		Ошибка
	</div>
<?}?>
