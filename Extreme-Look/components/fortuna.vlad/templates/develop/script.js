(function() {
    ...
    function assemblyCircle() {
        ...
        const paramColor = {
            'firstColor': $(popupContainerBX).hasClass('t-fortuna_default') ? '#cbbdf8' : $(popupContainerBX).hasClass('t-fortuna_winter') ? '#6e7bf9' : '#cbbdf8',
            'secondColor': $(popupContainerBX).hasClass('t-fortuna_default') ? '#b6aff9' : $(popupContainerBX).hasClass('t-fortuna_winter') ? '#3fa9f6' : '#b6aff9'
        }
        const prizes = [
            {
