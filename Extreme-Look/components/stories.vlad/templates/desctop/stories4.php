        ...
        <div class="slide-inner slide-video">
            <div class="slide-content">
                ...
                <video preload="auto" muted playsinline="true">
                    <source src="https://5f27e54cbb4614003053e2fb.storage.yandexcloud.net/505dbe1c-208d-496c-b611-e2c17630df31.MOV" type='video/mp4;codecs="avc1.42E01E, mp4a.40.2"'>
                </video>
    ...
    <div class="slide slick-slide">
        <div class="slide-inner slide-video">
            <div class="slide-content">
                <img class="canva" src="img/canva.png" />
                <video preload="auto" muted playsinline="true">
                    <source src="https://5f27e54cbb4614003053e2fb.storage.yandexcloud.net/863cd39e-a109-4f49-a153-ca51780709b8.MOV" type='video/mp4;codecs="avc1.42E01E, mp4a.40.2"'>
                </video>
                <div class="sound-control sound-control_unmute"></div>
                <div class="inner-next"></div>
                <div class="inner-prev"></div>
    ...
    <div class="slide slick-slide">
        <div class="slide-inner slide-video">
            <div class="slide-content">
                <img class="canva" src="img/canva.png" />
                <video preload="auto" muted playsinline="true">
                    <source src="https://5f27e54cbb4614003053e2fb.storage.yandexcloud.net/422248e3-2b73-46c2-b6e4-9d91d54c5412.MOV" type='video/mp4;codecs="avc1.42E01E, mp4a.40.2"'>
                </video>
                <div class="sound-control sound-control_unmute"></div>
                <div class="inner-next"></div>
                <div class="inner-prev"></div>
    ...
    <div class="slide slick-slide">
        <div class="slide-inner slide-video">
            <div class="slide-content">
                <img class="canva" src="img/canva.png" />
                <video preload="auto" muted playsinline="true">
                    <source src="https://5f27e54cbb4614003053e2fb.storage.yandexcloud.net/ebc1b3f7-cc25-45b9-8d98-15a27b281a95.MOV" type='video/mp4;codecs="avc1.42E01E, mp4a.40.2"'>
                </video>
                <div class="sound-control sound-control_unmute"></div>
                <div class="inner-next"></div>
                <div class="inner-prev"></div>
