...
<head>
    ...
    <title>Nina Klimenko Designer UX</title>


    <meta property="og:title" content="Nina Klimenko Designer UX" />
        ...
        <div class="slide-inner slide-video">
            <div class="slide-content">
                ...
                <video preload="auto" muted playsinline="true">
                    <source src="/bitrix/components/altop/stories.vlad/templates/.default/video/st1.mp4" type='video/mp4;codecs="avc1.42E01E, mp4a.40.2"'>
                </video>
    ...
    <div class="slide slick-slide">
        <div class="slide-inner slide-video">
            <div class="slide-content">
                <img class="canva" src="img/canva.png" />
                <video preload="auto" muted playsinline="true">
                    <source src="/bitrix/components/altop/stories.vlad/templates/.default/video/st2.mp4" type='video/mp4;codecs="avc1.42E01E, mp4a.40.2"'>
                </video>
                <div class="sound-control sound-control_unmute"></div>
                <div class="inner-next"></div>
                <div class="inner-prev"></div>
    ...
    <div class="slide slick-slide">
        <div class="slide-inner slide-video">
            <div class="slide-content">
                <img class="canva" src="img/canva.png" />
                <video preload="auto" muted playsinline="true">
                    <source src="/bitrix/components/altop/stories.vlad/templates/.default/video/st3.mp4" type='video/mp4;codecs="avc1.42E01E, mp4a.40.2"'>
                </video>
                <div class="sound-control sound-control_unmute"></div>
                <div class="inner-next"></div>
                <div class="inner-prev"></div>
    ...
    <div class="slide slick-slide">
        <div class="slide-inner slide-video">
            <div class="slide-content">
                <img class="canva" src="img/canva.png" />
                <video preload="auto" muted playsinline="true">
                    <source src="/bitrix/components/altop/stories.vlad/templates/.default/video/st4.mp4" type='video/mp4;codecs="avc1.42E01E, mp4a.40.2"'>
                </video>
                <div class="sound-control sound-control_unmute"></div>
                <div class="inner-next"></div>
                <div class="inner-prev"></div>
    ...
    <div class="slide slick-slide">
        <div class="slide-inner slide-video">
            <div class="slide-content">
                <img class="canva" src="img/canva.png" />
                <video preload="auto" muted playsinline="true">
                    <source src="/bitrix/components/altop/stories.vlad/templates/.default/video/st5.mp4" type='video/mp4;codecs="avc1.42E01E, mp4a.40.2"'>
                </video>
                <div class="sound-control sound-control_unmute"></div>
                <div class="inner-next"></div>
                <div class="inner-prev"></div>
