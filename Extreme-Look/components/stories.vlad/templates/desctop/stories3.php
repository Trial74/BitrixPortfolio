...
<head>
    ...
    <title>Barber Shon from LA</title>


    <meta property="og:title" content="Barber Shon from LA" />
    ...
    <script>(function(w,d,s,l,i){w[l]=w[l]||[];w[l].push({'gtm.start':
        ...
        })(window,document,'script','dataLayer','GTM-5WVLH7H');</script>
...
<div class="slider single-item">
    ...
    <div class="slide slick-slide">
        <div class="slide-inner">
            <div class="slide-content">
                ...
                <img data-lazy="https://5f0ffedae138de001f691de8.storage.yandexcloud.net/ee6422cf-be30-4c17-8ab9-87902fcb6f42.png"/>
    ...
    <div class="slide slick-slide">
        <div class="slide-inner">
            <div class="slide-content">
                <img class="canva" src="img/canva.png" />
                <img data-lazy="https://5f0ffedae138de001f691de8.storage.yandexcloud.net/cd63ae5a-4144-45e6-aeea-20c28010b22b.png"/>
                <div class="btns-container"><div class="inner-next"></div><div class="inner-prev"></div><div class="iplay"></div>
                    <a  class="" href="#"

                        style="background: none; text-align: center;background: none; background-size: contain; padding: 0; margin: 0 auto; width: 100%; text-align: center; overflow: visible; position: absolute;
              top:15%!important;
              right:10%!important;
              ...
              ">
                        <img src='https://5f0ffedae138de001f691de8.storage.yandexcloud.net/5b8c88b4-e6f8-4dde-8390-c658d2948426.gif' style='width: 100%; ' />
    ...
    <div class="slide slick-slide">
        <div class="slide-inner">
            <div class="slide-content">
                <img class="canva" src="img/canva.png" />
                <img data-lazy="https://5f0ffedae138de001f691de8.storage.yandexcloud.net/3e66d955-4bab-4b9f-ad3e-428ee73be87b.png"/>
                <div class="btns-container"><div class="inner-next"></div><div class="inner-prev"></div><div class="iplay"></div>
                    <a  class="" href="#"
              ...
              ">
                        <img src='https://5f0ffedae138de001f691de8.storage.yandexcloud.net/d19e5351-a022-4e85-9a85-7e8c37783b26.gif' style='width: 100%; ' />
                        <span style="position: absolute;">  </span>
                    </a>
                </div>
            </div>
    ...
    <div class="slide slick-slide">
        <div class="slide-inner">
            <div class="slide-content">
                <img class="canva" src="img/canva.png" />
                <img data-lazy="https://5f0ffedae138de001f691de8.storage.yandexcloud.net/29f6f137-d1d2-4b13-8dd3-2e3518b330d4.png"/>
                <div class="btns-container"><div class="inner-next"></div><div class="inner-prev"></div><div class="iplay"></div>
                    <a  class="" href="#"
              ...
              ">
                        <img src='https://5f0ffedae138de001f691de8.storage.yandexcloud.net/60cd2276-975d-411c-aaff-d49c20c345f4.gif' style='width: 100%; ' />
                        <span style="position: absolute;">  </span>
                    </a>
                </div>
            </div>
    ...
    <div class="slide slick-slide">
        <div class="slide-inner">
            <div class="slide-content">
                <img class="canva" src="img/canva.png" />
                <img data-lazy="https://5f0ffedae138de001f691de8.storage.yandexcloud.net/daf4dcaa-bd19-4b53-8a59-fc3dc74cbb5e.png"/>
                <div class="btns-container"><div class="inner-next"></div><div class="inner-prev"></div><div class="iplay"></div>
                    <a  class="" href="#"
              ...
              left:5%!important;
              ">
                        <img src='https://5f0ffedae138de001f691de8.storage.yandexcloud.net/aab66535-2447-44fe-82a1-7a4a39b01a8c.gif' style='width: 100%; ' />
                        <span style="position: absolute;">  </span>
                    </a>
                </div>
            </div>
    ...
    <div class="slide slick-slide">
        <div class="slide-inner">
            <div class="slide-content">
                <img class="canva" src="img/canva.png" />
                <img data-lazy="https://5f0ffedae138de001f691de8.storage.yandexcloud.net/c29cb3a7-33f1-4956-bc49-1df85380185f.png"/>
                <div class="btns-container"><div class="inner-next"></div><div class="inner-prev"></div><div class="iplay"></div>
                    <a  class="" href="#"
              ...
              ">
                        <img src='https://5f0ffedae138de001f691de8.storage.yandexcloud.net/d1d486c0-77cb-42d3-8d65-df0ecfe7f91c.gif' style='width: 100%; ' />
                        <span style="position: absolute;">  </span>
                    </a>

                    <a id="modal-btn-id-f174f85b0901" class="special-form-btn stop-slider" href="#modal-id-f174f85b0901"

                       style="background: #af52de;  text-align: center;  padding: 0; min-height: 5px; position: absolute;
                  top:34%!important;
                ...
                <div id="modal-id-f174f85b0901">
                    <!--THIS IS IMPORTANT! to close the modal, the class name has to match the name given on the ID  class="close-animatedModal" -->
                    <div class="c-modal-content" style="touch-action: none;">
                        <div class="close-modal-id-f174f85b0901 start-slider"></div>
                        <script>
                        </script>
                        <h3>Submit Now</h3>
                        <div class="form-slide">
                            <div class="form-info">
                                <input type="text" data-hide="false" style=""  autocomplete="off" class="user-name-input" placeholder="Name">
                                <input type="text" data-hide="false" style="" autocomplete="off" class="user-phone-input" placeholder="Phone">
                                <input type="text" data-hide="true" style="display: none" autocomplete="off" class="user-email-input" placeholder="Email">
                                <input type="hidden" value="12.10.2019" name="event-date" class="user-event-date-input">
                                <div>
                                    <input data-form-id=5f0ffedbe138de001f691dea class="form-submit" type="submit" name="submit" style="margin: 15px 10px; margin-bottom: 0;" value="Submit">
                                    <p>By clicking Submit, you agree to our <a href="https://app.slide.page/privacy" target="_blank" class="privacy">privacy policy</a>
                                    </p>
                                </div>
                            </div>
                        </div>
                        <div class="t-y">
                            ...
                            <a href="#" class="close-modal-id-f174f85b0901 start-slider">Back to site</a>
                        </div>
                    </div>
                </div>
...
<div class="progressBarContainer">
    ...
    <div><span data-slick-index="4" class="progressBar"></span></div>
    <div><span data-slick-index="5" class="progressBar"></span></div>
    <!-- progressbar -->
</div>
...
//          var isPlaying = video.currentTime > 0 && !currentVideo.paused && !currentVideo.ended
//          console.log('here 1')
                //if (!currentVideo.is(video) /*&& checkIsVideoPlaying(video.get(0))*/) {
//            console.log('here 2')
        ...
        /*
              var firstSlideInterval;
              var firstSlideVideo = $('.slide').eq(0).find('video');
              if (firstSlideVideo.length && firstSlideVideo.length > 0) {
                    firstSlideVideo.attr('poster', poster)
                    var iPlayElement = $('.slide').eq(0).find('.iplay')
                    firstSlideVideo[0].addEventListener('suspend', function(e) {
                        if (!checkIsVideoPlaying(firstSlideVideo[0]) && firstSlideVideo[0].currentTime == 0) {
                          console.log(e, firstSlideVideo[0])
                          iPlayElement.html("<img src='img/video-play-btn.png' alt='play' />")
                          stopSlider();
                          var checkedInterval = setInterval(function() {
                            if (checkIsVideoPlaying(firstSlideVideo[0])) {
                              iPlayElement.html("")
                    ...
                    firstSlideVideo[0].addEventListener('play', function() {
                        iPlayElement.html("")
                    })
              } */
        /*
              ...
              if (firstSlideVideo.length && firstSlideVideo.length > 0) {
                    ...
                    setTimeout(function() {
                      if (!checkIsVideoPlaying(firstSlideVideo[0])) {
                        iPlayElement.append("<img src='img/video-play-btn.png' alt='play' />")
                      }

                      firstSlideInterval = setInterval(function() {
                        if (!checkIsVideoPlaying(firstSlideVideo[0])) {
                          iPlayElement.html("<img src='img/video-play-btn.png' alt='play' />")
                        } else {
                          iPlayElement.html('')
        ...
        if (isPlaySound) {
            ...
            if (firstSlideVideo2.length && firstSlideVideo2.length > 0) {
                ...
                firstSlideVideo2.parent().find('.iplay').html("<img src='bitrix/components/altop/stories.vlad/templates/.default/img/video-play-btn.png' alt='play' />")
                $('.slider').slick("slickSetOption", "swipe", false);
            }
        }
        /*
        ...
        for (let i = 0; i < video.length; i++) {
          var fuckCache = video[i].currentSrc + "?r=" + Math.floor(Math.random() * Math.floor(1000));
          source[i].setAttribute("src", fuckCache);
          video[i].load();
        }*/
        /*
        var video = document.getElementsByTagName('video');
