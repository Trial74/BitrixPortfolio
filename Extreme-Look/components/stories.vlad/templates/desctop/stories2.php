...
<div class="slider single-item">
        ...
        <div class="slide-inner slide-video">
            <div class="slide-content">
                ...
                <video preload="auto" muted playsinline="true">
                    <source src="https://5faea3003f09eb001ee2fdef.storage.yandexcloud.net/276c382c-35fa-4f42-93e8-a736c53d7d66.mp4" type='video/mp4;codecs="avc1.42E01E, mp4a.40.2"'>
                </video>
    ...
    <div class="slide slick-slide">
        <div class="slide-inner">
            <div class="slide-content">
                <img class="canva" src="img/canva.png" />
                <img data-lazy="https://5faea3003f09eb001ee2fdef.storage.yandexcloud.net/c1cccb4b-cdbd-4f94-ac00-1303843561df.jpg"/>
                <div class="btns-container"><div class="inner-next"></div><div class="inner-prev"></div><div class="iplay"></div>
                    <a id="modal-btn-id-f175c22e55bf" class="special-form-btn stop-slider" href="#modal-id-f175c22e55bf"

                       style="background: linear-gradient(to right, #2F80ED, #56CCF2);  text-align: center;  padding: 0; min-height: 5px; position: absolute;
                ...
                <div id="modal-id-f175c22e55bf">
                    <!--THIS IS IMPORTANT! to close the modal, the class name has to match the name given on the ID  class="close-animatedModal" -->
                    <div class="c-modal-content" style="touch-action: none;">
                        <div class="close-modal-id-f175c22e55bf start-slider"></div>
                        <script>
                        </script>
                        <h3>Submit Now</h3>
                        <div class="form-slide">
                            <div class="form-info">
                                ...
                                <input type="text" data-hide="false" style="" autocomplete="off" class="user-email-input" placeholder="Email">
                                <input type="hidden" value="12.10.2019" name="event-date" class="user-event-date-input">
                                <div>
                                    <input data-form-id=5faea3013f09eb001ee2fdf1 class="form-submit" type="submit" name="submit" style="margin: 15px 10px; margin-bottom: 0;" value="Submit">
                        ...
                        <div class="t-y">
                            ...
                            <a href="#" class="close-modal-id-f175c22e55bf start-slider">Back to site</a>
                        </div>
                    </div>
                </div>
    ...
    <div class="slide slick-slide">
        <div class="slide-inner slide-video">
            <div class="slide-content">
                <img class="canva" src="img/canva.png" />
                <video preload="auto" muted playsinline="true">
                    <source src="https://5faea3003f09eb001ee2fdef.storage.yandexcloud.net/c58bfd5a-595d-417a-b8c3-015067f277d0.mp4" type='video/mp4;codecs="avc1.42E01E, mp4a.40.2"'>
                </video>
                <div class="sound-control sound-control_unmute"></div>
                <div class="btns-container"><div class="inner-next"></div><div class="inner-prev"></div><div class="iplay"></div>
                    <a id="modal-btn-id-f175c22eaacf" class="special-form-btn stop-slider" href="#modal-id-f175c22eaacf"
                ...
                <div id="modal-id-f175c22eaacf">
                    <!--THIS IS IMPORTANT! to close the modal, the class name has to match the name given on the ID  class="close-animatedModal" -->
                    <div class="c-modal-content" style="touch-action: none;">
                        <div class="close-modal-id-f175c22eaacf start-slider"></div>
                        <script>
                        </script>
                        <h3>Submit Now</h3>
                        <div class="form-slide">
                        ...
                        <div class="t-y">
                            ...
                            <p>Your contact information has been sent.</p>
                            <p>We will contact you as soon as possible.</p>
                            <a href="#" class="close-modal-id-f175c22eaacf start-slider">Back to site</a>
                        </div>
                    </div>
                </div>
    ...
    <div class="slide slick-slide">
        <div class="slide-inner">
            <div class="slide-content">
                <img class="canva" src="img/canva.png" />
                <img data-lazy="https://5faea3003f09eb001ee2fdef.storage.yandexcloud.net/9414b38e-f244-47a0-9ea8-3642d91f771a.jpg"/>
                <div class="btns-container"><div class="inner-next"></div><div class="inner-prev"></div><div class="iplay"></div>
                    <a id="modal-btn-id-f175c22ebcca" class="special-form-btn stop-slider" href="#modal-id-f175c22ebcca"
                ...
                <div id="modal-id-f175c22ebcca">
                    <!--THIS IS IMPORTANT! to close the modal, the class name has to match the name given on the ID  class="close-animatedModal" -->
                    <div class="c-modal-content" style="touch-action: none;">
                        <div class="close-modal-id-f175c22ebcca start-slider"></div>
                        <script>
                        </script>
                        <h3>Submit Now</h3>
                        <div class="form-slide">
                        ...
                        <div class="t-y">
                            ...
                            <p>Your contact information has been sent.</p>
                            <p>We will contact you as soon as possible.</p>
                            <a href="#" class="close-modal-id-f175c22ebcca start-slider">Back to site</a>
                        </div>
                    </div>
                </div>
    ...
    <div class="slide slick-slide">
        <div class="slide-inner">
            <div class="slide-content">
                <img class="canva" src="img/canva.png" />
                <img data-lazy="https://5faea3003f09eb001ee2fdef.storage.yandexcloud.net/623f0659-d838-486e-ae30-00f22dca00a9.jpg"/>
                <div class="btns-container"><div class="inner-next"></div><div class="inner-prev"></div><div class="iplay"></div>
                    <a id="modal-btn-id-f175c22ecb1f" class="special-form-btn stop-slider" href="#modal-id-f175c22ecb1f"
                ...
                <div id="modal-id-f175c22ecb1f">
                    <!--THIS IS IMPORTANT! to close the modal, the class name has to match the name given on the ID  class="close-animatedModal" -->
                    <div class="c-modal-content" style="touch-action: none;">
                        <div class="close-modal-id-f175c22ecb1f start-slider"></div>
                        <script>
                        </script>
                        <h3>Submit Now</h3>
                        <div class="form-slide">
                        ...
                        <div class="t-y">
                            ...
                            <p>Your contact information has been sent.</p>
                            <p>We will contact you as soon as possible.</p>
                            <a href="#" class="close-modal-id-f175c22ecb1f start-slider">Back to site</a>
                        </div>
                    </div>
                </div>
