        ...
        <div class="slide-inner slide-video">
            <div class="slide-content">
                ...
                <video preload="auto" autoplay loop muted playsinline>
                    <source src="/bitrix/components/altop/stories.vlad/templates/.default/video/storis2/stor2_1.mp4?071220211" type='video/mp4;codecs="avc1.42E01E, mp4a.40.2"'>
                </video>
                ...
                <div class="iplay"></div>
                <a class="stop-slider" onclick="goTo(1)" href="#" style="padding: 0; min-height: 5px; position: absolute;
                           bottom: 0!important;
                           width: 100%!important;
    ...
    <div class="slide slick-slide">
        <div class="slide-inner slide-video">
            <div class="slide-content">
                <img class="canva" src="img/canva.png" />
                <video preload="auto" autoplay loop muted playsinline>
                    <source src="/bitrix/components/altop/stories.vlad/templates/.default/video/storis2/stor2_2.mp4?071220212" type='video/mp4;codecs="avc1.42E01E, mp4a.40.2"'>
                </video>
                <div class="sound-control sound-control_unmute"></div>
                <div class="exit-storis"></div>
                <div class="inner-next"></div>
                <div class="inner-prev"></div>
                <div class="iplay"></div>
                <a class="stop-slider" onclick="goTo(2)" href="#" style="padding: 0; min-height: 5px; position: absolute;
                           bottom: 0!important;
                           width: 100%!important;
                           height: 80px!important;
                           background: transparent !important;
    ...
    <div class="slide slick-slide">
        <div class="slide-inner slide-video">
            <div class="slide-content">
                <img class="canva" src="img/canva.png" />
                <video preload="auto" autoplay loop muted playsinline>
                    <source src="/bitrix/components/altop/stories.vlad/templates/.default/video/storis2/stor2_3.mp4?071220213" type='video/mp4;codecs="avc1.42E01E, mp4a.40.2"'>
                </video>
                <div class="sound-control sound-control_unmute"></div>
                <div class="exit-storis"></div>
                <div class="inner-next"></div>
    ...
    <div class="slide slick-slide">
        <div class="slide-inner slide-video">
            <div class="slide-content">
                <img class="canva" src="img/canva.png" />
                <video preload="auto" autoplay loop muted playsinline>
                    <source src="/bitrix/components/altop/stories.vlad/templates/.default/video/storis2/stor2_4.mp4?07122024" type='video/mp4;codecs="avc1.42E01E, mp4a.40.2"'>
                </video>
                <div class="sound-control sound-control_unmute"></div>
                <div class="exit-storis"></div>
                <div class="inner-next"></div>
    ...
    <div class="slide slick-slide">
        <div class="slide-inner slide-video">
            <div class="slide-content">
                <img class="canva" src="img/canva.png" />
                <video preload="auto" autoplay loop muted playsinline>
                    <source src="/bitrix/components/altop/stories.vlad/templates/.default/video/storis2/stor2_5.mp4?07122025" type='video/mp4;codecs="avc1.42E01E, mp4a.40.2"'>
                </video>
                <div class="sound-control sound-control_unmute"></div>
                <div class="exit-storis"></div>
                <div class="inner-next"></div>
                <div class="inner-prev"></div>
                <div class="iplay"></div>
                <a class="stop-slider" onclick="goTo(4)" href="#" style="padding: 0; min-height: 5px; position: absolute;
                           bottom: 0!important;
                           width: 100%!important;
                           height: 80px!important;
                           background: transparent !important;
...
<script type="text/javascript">
    ...
    function goTo(id) { //ссылки в сторисах
        ...
        switch (id) {
            case 1:
                if(app)
                    uri = '/page-catalog.section/section-id=397/';
                else
                    uri = '/catalog/kley_dlya_narashchivaniya_resnits_/';
                break;
            case 2:
                if(app)
                    uri = '/page-catalog.section/section-id=397/';
