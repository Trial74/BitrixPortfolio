    ...
    l.fn.animatedModal = function (a) {
        ...
        e.css(r), n.click(function (a) {
            a.preventDefault(), l("body, html").css({
                ...
                opacity: o.opacityIn,
                "z-index": o.zIndexIn
            }), e.addClass(o.animatedIn), e.one("webkitAnimationEnd mozAnimationEnd MSAnimationEnd oanimationend animationend", m))), l("body").addClass('popup-active')
        }), t.click(function (a) {
            a.preventDefault(), l("body, html").css({
                overflow: "auto"
            }), l("body").removeClass('popup-active'), o.beforeClose(), e.hasClass(o.modalTarget + "-on") && (e.removeClass(o.modalTarget + "-on"), e.addClass(o.modalTarget + "-off")), e.hasClass(o.modalTarget + "-off") && (e.removeClass(o.animatedIn), e.addClass(o.animatedOut), e.one("webkitAnimationEnd mozAnimationEnd MSAnimationEnd oanimationend animationend", s))
        })
    }
}(jQuery);