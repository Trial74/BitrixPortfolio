        ...
        <div class="slide-inner slide-video">
            <div class="slide-content">
                ...
                <video preload="auto" autoplay loop muted playsinline>
                    <source src="/bitrix/components/altop/stories.vlad/templates/.default/video/storis3/stor3_1.mp4?<?=time()?>" type='video/mp4;codecs="avc1.42E01E, mp4a.40.2"'>
                </video>
                ...
                <div class="iplay"></div>
                <a class="stop-slider" onclick="goTo(1)" href="#" style="
                    padding: 0;
                    min-height: 5px;
                    position: absolute;
    ...
    <div class="slide slick-slide">
        <div class="slide-inner slide-video">
            <div class="slide-content">
                <img class="canva" src="img/canva.png" />
                <video preload="auto" autoplay loop muted playsinline>
                    <source src="/bitrix/components/altop/stories.vlad/templates/.default/video/storis3/stor3_2.mp4?<?=time()?>" type='video/mp4;codecs="avc1.42E01E, mp4a.40.2"'>
                </video>
                <div class="sound-control sound-control_unmute"></div>
                <div class="exit-storis"></div>
                <div class="inner-next"></div>
    ...
    <div class="slide slick-slide">
        <div class="slide-inner slide-video">
            <div class="slide-content">
                <img class="canva" src="img/canva.png" />
                <video preload="auto" autoplay loop muted playsinline>
                    <source src="/bitrix/components/altop/stories.vlad/templates/.default/video/storis3/stor3_3.mp4?<?=time()?>" type='video/mp4;codecs="avc1.42E01E, mp4a.40.2"'>
                </video>
                <div class="sound-control sound-control_unmute"></div>
                <div class="exit-storis"></div>
                <div class="inner-next"></div>
