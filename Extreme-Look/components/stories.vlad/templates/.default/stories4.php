        ...
        <div class="slide-inner slide-video">
            <div class="slide-content">
                ...
                <video preload="auto" autoplay loop muted playsinline>
                    <source src="/bitrix/components/altop/stories.vlad/templates/.default/video/storis4/stor4_1.mp4" type='video/mp4;codecs="avc1.42E01E, mp4a.40.2"'>
                </video>
    ...
    <div class="slide slick-slide">
        <div class="slide-inner slide-video">
            <div class="slide-content">
                <img class="canva" src="img/canva.png" />
                <video preload="auto" autoplay loop muted playsinline>
                    <source src="/bitrix/components/altop/stories.vlad/templates/.default/video/storis4/stor4_2.mp4" type='video/mp4;codecs="avc1.42E01E, mp4a.40.2"'>
                </video>
                <div class="sound-control sound-control_unmute"></div>
                <div class="exit-storis"></div>
                <div class="inner-next"></div>
...
<script type="text/javascript">
    ...
    function goTo(id) { //ссылки в сторисах
        ...
        switch (id) {
            case 1:
                if(app)
                    uri = '/page-catalog.element/element-id=12512/';
                else
                    uri = '/catalog/pintsety_dlya_resnits_comfort_pro_adaptirovannaya_rukoyatka_pintsetov_dlya_udobnogo_ispolzovaniya/pintset_anatomic_l/';
                break;
            case 2:
                if(app)
                    uri = '/';
