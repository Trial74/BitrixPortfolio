...
<?$APPLICATION->SetTitle("Доставка");?>
    ...
    <div class="text-one-t one">Стоимость доставки товара из нашего магазина по <span class="col-ex">г. Челябинск - бесплатна<sup><span style="font-size: 8pt;">2</span></sup></span>, при условии выбора товаров на сумму, не менее 2000 руб.</div>
    <div class="text-one-t two">Доставка осуществляется <span class="col-ex">по 100% предоплате</span> Вашего заказа.</div>
    <div class="text-one-t three" style="margin-bottom: 30px;"><span class="col-ex">Время доставки согласовывается с менеджером Службы доставки</span>, который обязательно свяжется с вами сразу после того, как Вы разместите свой заказ.</div>

    <div class="block-banner-one">
        <div class="info-banner-one">
            <div class="text-banner-one-t">Доставка в регионы РФ</div>
            <div class="text-banner-one-after">Для покупателей из регионов</div>
            <div class="text-banner-two text-info-opt">Стоимость доставки зависит от выбора транспортной компании.</div>
        </div>
    ...
    <div class="footer-delivery">
        ...
        <div><sup><span style="font-size: 8pt;">2*</span></sup> Стоимость доставки в удаленные районы г. Челябинск, а также, если сумма Вашего заказа менее 2000 руб, составляет 200 руб. К удаленным районам относятся: Ленинский, Металлургический, Советский, Тракторозаводский.</div>
        <div><sup><span style="font-size: 8pt;">3*</span></sup> Если вес отправления больше 10 кг или заказ содержит товары из раздела освещение/кушетки - будет произведен индивидуальный расчет. Стоимость отправления за пределы РФ производится по индивидуальному расчету.</div>
    </div>
