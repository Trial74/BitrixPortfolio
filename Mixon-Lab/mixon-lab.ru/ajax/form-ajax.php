...
if($request->isAjaxRequest()) {
    ...
    switch($action) {
        case "get-offer":
            $C_FIELD['THEME'] = 'Заполнена форма "Получить предложение"';
            $C_FIELD['NAME'] = $data['OFFER-NAME'];
            $C_FIELD['PHONE'] = $data['OFFER-PHONE'];
            $C_FIELD['MAIL'] = $data['OFFER-MAIL'];
            $UF_FIELD = 'Заполнена форма "Получить предложение"| ' . $data["OFFER-NAME"] . ' | ' . $data['OFFER-PHONE'] . ' | ' . $data['OFFER-MAIL'] . ' | ' . $today;
            ...
            $C_FIELD['THEME'] = 'Форма "Получить предложение" - ' . $C_FIELD['NAME'];
        ...
        break;
        case "get-price":
            $C_FIELD['THEME'] = 'Заполнена форма "Узнать стоимость"';
            ...
            $UF_FIELD = 'Заполнена форма "Узнать стоимость"| ' . $data["PRICE-NAME"] . ' | ' . $data['PRICE-PHONE'] . ' | ' . $data['PRICE-MAIL'] . ' | ' . $data['PRICE-PROIZ'] . ' | ' . $data['PRICE-OBIEM'] . ' | ' . $today;
            ...
            $C_FIELD['THEME'] = 'Форма "Узнать стоимость" - ' . $C_FIELD['NAME'];
            $HOOK_B24::addContact($C_FIELD, true);
        ...
        case "get-feedback":
            ...
            $C_FIELD['THEME'] = 'Заполнена форма "Обратной связи"';
            $C_FIELD['NAME'] = $data['CONTACTS-NAME'];
            $C_FIELD['PHONE'] = $data['CONTACTS-PHONE'];
            $C_FIELD['MAIL'] = $data['CONTACTS-MAIL'];

            $UF_FIELD = 'Заполнена форма "Обратная связь"| ' . $data["CONTACTS-NAME"] . ' | ' . $data['CONTACTS-PHONE'] . ' | ' . $data['CONTACTS-MAIL'] . ' | ' . $today;
            ...
            $C_FIELD['THEME'] = 'Форма "Обратная связь" - ' . $C_FIELD['NAME'];
            $HOOK_B24::addContact($C_FIELD, true);
        ...
        break;
        case "test-message":
            $C_FIELD['THEME'] = 'Тестовое письмо для проверки MIXON';
            $C_FIELD['NAME'] = 'Влад';
            $C_FIELD['PHONE'] = '///';
            $C_FIELD['MAIL'] = '////';
